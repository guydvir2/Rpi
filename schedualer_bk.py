...
#class GUI:
    ...
    #def __init__(self,master):
        ...
        #master.geometry("+0+%d"%(screen_height))
        #master.configure(background=bg_window)
        #master.title("Schedualer to Raspberry Pi")

 

    #### Week Schedule GUI ###

    #sched_frame=LabelFrame(master,text="Weekly Schedule",padx=10,bg=bg_window,
    ...
    #frame_leds=LabelFrame(master, text="Manual Switch Pannel",bg=bg_window,
    ...
    #frame_mainbuttons=LabelFrame(master, text="Buttons",bg=bg_window,
