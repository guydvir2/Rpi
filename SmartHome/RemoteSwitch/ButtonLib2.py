...
if __name__ == "__main__":
    ...
    #f = UpDownButton(root, nickname='F-RoomWindow', ip_out='192.168.2.114', hw_out=[26,19],    sched_vector2=[[[1], "22:24:30", "23:12:10"], [[7, 4], "08:56:00", "11:50:10"]])
    ## sched_vector=[[[6], "1:24:30", "23:12:10"]])
    #f.grid(row=0, column=1, sticky=tk.S)
    #f1 = UpDownButton(root, nickname='P-RoomWindow', ip_out='192.168.2.116', hw_out=[26,19])
    ## sched_vector=[[[6], "1:24:30", "23:12:10"]])
    #f1.grid(row=0, column=1, sticky=tk.S)

    f1 = UpDownButton(root, nickname='Loc_pi113', ip_out='192.168.2.118', hw_out=[26,19])
		# sched_vector=[[[6], "1:24:30", "23:12:10"]])
    f1.grid(row=0, column=1, sticky=tk.S)
