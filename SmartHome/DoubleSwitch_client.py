...
try:
    file_logger = envelope_localswitch.Log2File('double_switch.log', screen=0)
    double_switch = localswitches.DoubleSwitch(26, 19, 21, 20, name='DS')

    # Disp on LCD
    envelope_localswitch.ShowStatusLCD([double_switch.switch0, double_switch.switch1], ext_log=file_logger)
    time.sleep(1)
