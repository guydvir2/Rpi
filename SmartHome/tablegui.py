...
class CoreTable(ttk.Frame):
    def __init__(self, data_filename=''):
        ...
        self.style.configure("bg.TFrame", background='red')

        self.table_frame = ttk.Frame(self, style='bg.TFrame')
        self.table_frame.grid(row=0, column=0)

        self.button_frame = ttk.Frame(self, style='bg.TFrame')
        self.button_frame.grid(row=0, column=1, padx=10, sticky=tk.S)

        self.status_frame = ttk.Frame(self, style="bg.TFrame")
    ...
    def status_bar(self):
        ttk.Label(self.status_frame, text='filename: '+str(self.filename), relief=tk.RIDGE).grid()
